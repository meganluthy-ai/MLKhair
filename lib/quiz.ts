...
export const intake: Section[] = [
  ...
  },
  {
    ...
    fields: [
      { id: "postmenopausal", type: "radio", label: "Are you postmenopausal?", options: YN },
      { id: "cycleIssues", type: "radio", label: "Any issues with your cycle (severe pain, etc.)?", options: YN, showIf: { field: "postmenopausal", equals: "No" } },
      { id: "pregnant", type: "radio", label: "Are you currently pregnant or breastfeeding?", options: YN, showIf: { field: "postmenopausal", equals: "No" } },
      { id: "planningPregnancy", type: "radio", label: "Planning to get pregnant in the next 6 months?", options: YN, showIf: { field: "postmenopausal", equals: "No" } },
      { id: "contraceptive", type: "radio", label: "Do you take contraceptive pills?", options: YN, showIf: { field: "postmenopausal", equals: "No" } },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "bothersMost", type: "grid", label: "How much does hair loss bother you in each of these?", help: "Rank each one. Choose Not applicable if it does not apply to you.", cols: ["Not applicable", "A little", "Moderately", "A lot"], rows: ["No variation in hairstyle", "Going outside on windy days", "Social life", "Seeing old friends", "Participating in sports", "Overall appearance", "Conscious of appearance at work", "Seeing pictures or videos", "Wearing hats when going out", "Swimming or getting caught in the rain", "Overall self-esteem", "Meeting new people", "People make comments"] },
    ],
  },
  {
    title: "Family history",
    desc: "Hair loss often runs in families. For each relative, mark what fits.",
    fields: [
      { id: "familyGrid", type: "grid", label: "For each relative, what is their hair status?", rows: ["Parents", "Grandparents", "Siblings", "Aunt", "Uncle"], cols: ["Bald", "Thinning hair", "Not bald", "Unknown"] },
    ...
    fields: [
      {
        ...
        type: "radio",
        label:
          "I consent to a comprehensive preliminary hair and scalp evaluation before beginning my plan. I understand that check-ins are included with my program and will include monthly or quarterly digital and microscopic photos to track progress. I understand that hair restoration is a gradual process, that treatment requires at least 6 months of consistency, and that the best visible results are typically seen around months 9 to 12. Results vary, and I am responsible for reporting any changes in my health, scalp, hair, medications, or treatment plan.",
